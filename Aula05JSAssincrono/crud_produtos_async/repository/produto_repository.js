...
function listar() {
    return Promise.resolve(listaProdutos); //retorna uma promise de array de produtos, ou seja, a resposta da função é uma promise que resolve para um array de produtos
}
